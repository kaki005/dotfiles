...
New-Item -ItemType SymbolicLink -Path %localappdata%\clink -Name clink_settings -Value $HOME/dotfiles/dotfiles/windows/clink_settings
New-Item -ItemType SymbolicLink -Path %localappdata%\clink -Name aliases -Value $HOME/dotfiles/dotfiles/window/aliases
New-Item -ItemType SymbolicLin -Path %localappdata%\clink -Name plugin.lua -Value $HOME/dotfiles/dotfiles/windows/plugin.lua
# Vscode
