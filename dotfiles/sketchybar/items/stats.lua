...
sbar.exec(
	'killall stats_provider >/dev/null; $HOME/.local/share/sketchybar-system-stats/target/release/stats_provider --cpu usage temperature --disk usage --memory ram_usage')
